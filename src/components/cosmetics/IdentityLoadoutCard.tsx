...
export default function IdentityLoadoutCard({
  ...
  const bannerStyle = (banner.assetPath ? { "--identity-banner-art": `url("${banner.assetPath}")` } : undefined) as CSSProperties | undefined;
  ...
  return (
    <div
      ...
      style={cardStyle}
    >
      <div className={cn("identity-loadout-banner", banner.className)} style={bannerStyle}>
      ...
      <div className="identity-loadout-main">
        ...
        <div className="identity-loadout-copy">
          ...
          <div className="identity-loadout-meta">
            <span className={cn("identity-loadout-emblem", emblem.className)}>
              <span>{emblem.glyph ?? "PR"}</span>
              {emblemLabel ?? emblem.label}
            </span>
            <span className={cn("identity-loadout-chip", card.chipClassName)}>{card.label}</span>
          </div>
        </div>
