...
export const NEON_RIVALS_RUN_MODE_OPTIONS: NeonRivalsRunModeOption[] = [
  ...
  },
  {
    ...
    boardFamily: "link",
    label: "Link Lock",
    kicker: "Node-link lane",
    description: "Connect every matching node pair across the grid without crossing a live route.",
  },
  {
    id: "mirror_maze",
    boardFamily: "mirror",
    label: "Mirror Maze",
    kicker: "Beam route lane",
    description: "Rotate reflectors, bend the live beam, and light every target before the route budget collapses.",
  },
  {
    id: "tile_shift",
    boardFamily: "tile",
...
const OBJECTIVE_PRESETS: Record<Exclude<NeonRivalsRunMode, "color_hunt" | "combo_rush">, ObjectivePreset> = {
  ...
  link_lock: {
    boardFamily: "link",
    title: "Link Lock",
    label: "Connect every node pair without crossing a live route before the move budget expires.",
    description: "Start at a glowing node, drag a clean route into its partner, and lock the whole board one link at a time.",
    targetValue: 100,
    targetScore: 1820,
    startingMoves: 16,
    resourceLabel: "moves",
  ...
  mirror_maze: {
    boardFamily: "mirror",
    title: "Mirror Maze",
    label: "Rotate the reflectors until the beam lights every target on the board.",
    description: "Every turn changes the beam path instantly. Chase multi-target reflections and avoid wasting rotations.",
    targetValue: 100,
    targetScore: 1880,
    startingMoves: 14,
    resourceLabel: "moves",
