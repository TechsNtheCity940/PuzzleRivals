...
export const BOARD_ORIGIN_Y = 108;
export const BOARD_VIEWPORT_X = 88;
export const BOARD_VIEWPORT_Y = 84;
export const BOARD_VIEWPORT_WIDTH = 904;
export const BOARD_VIEWPORT_HEIGHT = 904;
